use crate::{Position, Res, WindowSize};
...
pub trait WindowModifiers {
    ...
    fn min_inner_size<S: Into<WindowSize>>(self, size: impl Res<S>) -> Self;
    fn max_inner_size<S: Into<WindowSize>>(self, size: impl Res<S>) -> Self;
