        ...
        VStack::new(cx, |cx| {
            HStack::new(cx, |cx| {
                Button::new(cx, |_| {}, |cx| Label::new(cx, "Button 1"))
                    .on_focus(|cx| cx.emit(AppEvent::SetText("Button 1".to_string())))
                    .on_focus_out(|cx| cx.emit(AppEvent::SetText("".to_string())));
                Button::new(cx, |_| {}, |cx| Label::new(cx, "Button 2"))
                    .on_focus(|cx| cx.emit(AppEvent::SetText("Button 2".to_string())))
                    .on_focus_out(|cx| cx.emit(AppEvent::SetText("".to_string())));
                Button::new(cx, |_| {}, |cx| Label::new(cx, "Button 3"))
                    .on_focus(|cx| cx.emit(AppEvent::SetText("Button 3".to_string())))
                    .on_focus_out(|cx| cx.emit(AppEvent::SetText("".to_string())));
            })
