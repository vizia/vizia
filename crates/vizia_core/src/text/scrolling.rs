...
pub fn enforce_text_bounds(bounds: &BoundingBox, parent_bounds: &BoundingBox, transform: (f32, f32)) -> (f32, f32) {
...
pub fn ensure_visible(bounds: &BoundingBox, parent_bounds: &BoundingBox, transform: (f32, f32)) -> (f32, f32) {
    let (mut tx, mut ty) = transform;
