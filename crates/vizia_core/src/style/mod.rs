...
pub use vizia_style::{
    ...
    LineClamp, LineDirection, LinearGradient, Matrix, Offset, Opacity, Overflow, PointerEvents,
...
pub struct Style {
    ...
    // Position
    pub(crate) position: StyleSet<Position>,
    ...
    fn insert_property(&mut self, rule_id: Rule, property: Property) {
        match property {
            ...
            Property::Position(position) => {
                self.position.insert_rule(rule_id, position);
            }
