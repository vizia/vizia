...
pub struct AccessibilityChildIterator<'a, I>
where
    I: GenerationalId,
{
    tree: &'a Tree<I>,
...
impl<'a, I> AccessibilityChildIterator<'a, I>
where
    I: GenerationalId,
{
    pub fn new(tree: &'a Tree<I>, node: I) -> Self {
...
impl<'a, I> Iterator for AccessibilityChildIterator<'a, I>
where
    I: GenerationalId,
{
    type Item = I;
...
impl<'a, I> DoubleEndedIterator for AccessibilityChildIterator<'a, I>
where
    I: GenerationalId,
{
    fn next_back(&mut self) -> Option<Self::Item> {
